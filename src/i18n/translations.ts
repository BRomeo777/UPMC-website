...
const en: Translations = {
  ...
  contact: {
    ...
    findUs: "Find Us", findUsSubtitle: "Rwanda, Northern Province · Muhanga District · Shyogwe Sector",
...
const rw: Translations = {
  ...
  contact: {
    ...
    findUs: "Aho Duherereye", findUsSubtitle: "Rwanda, Intara y'Amajyaruguru · Akarere ka Muhanga · Umurenge wa Shyogwe",
...
const fr: Translations = {
  ...
  contact: {
    ...
    findUs: "Nous Trouver", findUsSubtitle: "Rwanda, Province du Nord · District de Muhanga · Secteur de Shyogwe",
...
const sw: Translations = {
  ...
  contact: {
    ...
    findUs: "Tupate", findUsSubtitle: "Rwanda, Mkoa wa Kaskazini · Wilaya ya Muhanga · Sekta ya Shyogwe",
