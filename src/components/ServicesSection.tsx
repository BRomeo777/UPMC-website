...
const DEFAULT_SERVICES: SvcCard[] = [
  ...
  { id: "hospitalisation-internal", dept: "Hospitalisation", subDept: "", title: "Adult Hospitalisation", description: "Inpatient care and monitoring for adult patients requiring close medical supervision, treatment, and recovery under the Internal Medicine team.", imageKey: "hospitalisation-internal" },
